...
class Employee implements Serializable{
	...
	Employee(int eno, String eName,int Salary)throws Exception{
		this.eno=eno;
		this.eName=eName;
		this.Salary=Salary;
	}
...
class EmployeeDemo {
	public static void main(String[] args)throws Exception {
		...
		System.out.println("*************************************************");
		System.out.println("Created by Mahesh Rajguru");
		System.out.println("*************************************************");
		...
		do{
			...
			System.out.println("7. Sort by Employee no- on File:");
			System.out.println("8. Sort by Employee Name- on screen:");
			System.out.println("9. Sort by Employee Name- on File:");
			System.out.println("10. Sort by Employee Salary- on screen:");
			System.out.println("11. Sort by Employee Salary- on File:");
